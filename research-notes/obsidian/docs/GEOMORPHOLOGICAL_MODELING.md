...
Геоморфологическое моделирование представляет собой систему симуляции эволюции береговой линии под воздействием волновой эрозии, транспорта наносов, литологических особенностей и параметрических временных факторов, включая штормовые события, сезонность и подъём уровня моря. Текущие временные предустановки не являются климатическими траекториями.
...
**Условная частота при независимой вероятности на каждом годовом шаге:**

| Вероятность | Математическое ожидание интервала | Условный уровень воздействия |
|-------------|-----------------|----------------|
...
Это схема Бернулли, а не распределение штормов, полученное из наблюдений или
климатической модели. Она не описывает длительность, сезонную кластеризацию и
...
**Примеры вручную задаваемых значений:**
...
Эти значения предназначены только для анализа чувствительности и не
представляют RCP/SSP, прогноз для конкретного года или результат климатической
модели. Для климатического моделирования нужны реальные временные ряды уровня
моря и волнения, распределения штормов и документированные источники всех
сценарных параметров.
