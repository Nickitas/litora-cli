...
### 1. **Визуализация sediment transport**
Сейчас модель считает transport, но не показывает его распределение. Можно добавить:
- Карту аккумуляции/эрозии с цветовой кодировкой
- Векторы longshore drift на SVG
- Статистику по точкам аккумуляции

### 2. **Детализация по сегментам берега**
Сейчас метрики усредненные. Можно добавить:
- Анализ по сегментам (бухты, мысы)
- Выявление проблемных зон
- Сравнение защищенных/незащищенных участков

### 3. **Улучшение временной динамики**
...
### 4. **Более реалистичная литология**
