...
func getCommandUX(command string) commandUX {
	...
	case cmdBenchmark:
		return commandUX{
			Mode:        "калибровка и верификация",
			Summary:     "управление контрольными участками с известными данными эрозии для калибровки модели",
			RuntimeNote: "позволяет создавать, просматривать и использовать benchmark sites для верификации модели",
		}
	default:
		return commandUX{}
	}
