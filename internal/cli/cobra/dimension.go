...
func printObservedDimension(points []geometry.LatLon, analysis fractal.BoxCountingAnalysis) {
	...
	w.Flush()
	fmt.Println("\nИнтерпретация: оценка относится только к загруженным наблюдениям и доступному диапазону масштабов.")
}
