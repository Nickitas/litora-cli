...
// WaveCondition описывает одно наблюдаемое, реанализированное или прогнозное
// состояние волн в глубокой воде. Направление задаётся как направление,
// ОТКУДА приходят волны, по часовой стрелке от севера.
