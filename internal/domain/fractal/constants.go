...
const (
	// refLat - референсная широта для Чёрного моря (градусы)
	refLat = 43.5

	// refLon - референсная долгота для Чёрного моря (градусы)
	refLon = 35.0

	// metersPerDegLat - метров на градус широты
	metersPerDegLat = 111194.9

	// metersPerDegLon - метров на градус долготы (для Чёрного моря)
