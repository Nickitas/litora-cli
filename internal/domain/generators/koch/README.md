...
Органический Кох добавляет стохастические вариации к классическому алгоритму и
создаёт синтетические формы для учебных демонстраций и тестирования:

- **Классический Кох:** идеальная симметрия, неестественно «правильные» формы
- **Органический Кох:** стохастические вариации угла и высоты без претензии на модель природного генезиса
...
Генератор не является доказательством фрактальности природной береговой линии.
В CLI он доступен только через учебную команду `lito koch-demo`; научная
команда `lito dimension` анализирует неизменённые наблюдаемые координаты.
