# .PHONY: all build test lint clean ci bathymetry help erosion erosion-with-bathymetry build-all build-release
...
# 	@echo "  make lint                 - Проверка форматирования и vet"
# 	@echo "  make ci                   - Полная CI проверка (lint + test)"
